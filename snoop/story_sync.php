<?php
/**
 * Snoop Story Planner - Sync Backend
 *
 * Drop this next to story_planner.html on any PHP server.
 * Creates a _snoop_data/ folder to store state.
